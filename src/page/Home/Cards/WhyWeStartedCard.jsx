      ...
      >
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
            ...
            <ShoppingBagTwoToneIcon sx={{ color: '#d35400', mt: 0.5, fontSize: 28 }} />
            ...
            >
              আমাদের প্রতিদিনের জীবনের একটা বড় অংশ হলো বাজার করা। কিন্তু এই সাধারণ কাজটাই অনেক সময় আমাদের জন্য চিন্তার কারণ হয়ে দাঁড়ায়। আপনাদের এই প্রতিদিনের সমস্যাগুলো খুব কাছ থেকে দেখেই আমাদের মনে হলো—এমন কিছু করা দরকার যা আপনাদের <strong>জীবনকে একটু সহজ করবে</strong>। আর সেই ভাবনা থেকেই জন্ম নিয়েছে <strong>"রোজের বাজার"</strong>।
            </Typography>
          </Box>
