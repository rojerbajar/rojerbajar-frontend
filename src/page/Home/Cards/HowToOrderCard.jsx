  ...
  return (
      ...
      >
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          >
            আপনাদের বাজার করার অভিজ্ঞতাকে একদম সহজ ও আপন করতে Rojerbajar-এ আমরা
            অর্ডার দেওয়ার পদ্ধতিটি খুব সাধারণ রেখেছি। আপাতত নিচের যেকোনো উপায়ে
            আমাদের কাছে অর্ডার দিতে পারেন:
          </Typography>
          ...
          <Stack spacing={3}>
            ...
            <Box sx={{ display: "flex", gap: 2, alignItems: "flex-start" }}>
              ...
              <Box sx={{ textAlign: "left" }}>
                <Typography fontWeight="800" sx={{ color: "#4e2c1d" }}>
                  সরাসরি ফোন কল:
                </Typography>
                <Typography sx={{ color: "#444444", fontSize: "0.95rem" }}>
                  ...
                  নম্বরে, আর আপনার বাজারের লিস্টটি আমাদের মুখে বলে দিন। বাকি
                  দায়িত্ব আমাদের।
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: 2, alignItems: "flex-start" }}>
              ...
              <Box sx={{ textAlign: "left" }}>
                ...
                <Typography sx={{ color: "#444444", fontSize: "0.95rem" }}>
                  ...
                  নম্বরে লিস্টটি টাইপ করে পাঠান অথবা একটি 'ভয়েস মেসেজ' দিন।
                  আমরা শুনেই আপনার বাজারের থলে গুছিয়ে নেব।
                </Typography>
              </Box>
            </Box>
            ...
            >
              ...
              >
                ...
                ইতিমধ্যেই তৈরি আছে। তবে কেনাকাটা আরও সহজ করতে সেখানে কিছু নতুন
                কাজ চলছে।
              </Typography>
              <Typography
                sx={{
              ...
              >
                খুব শীঘ্রই আপনারা এক ক্লিকেই অর্ডার করতে পারবেন। ততদিন ফোন বা
                হোয়াটসঅ্যাপের মাধ্যমেই আপনাদের সেবা করতে আমরা প্রস্তুত।
              </Typography>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: 2, alignItems: "flex-start" }}>
              ...
              <Box sx={{ textAlign: "left" }}>
                ...
                <Typography sx={{ color: "#444444", fontSize: "0.95rem" }}>
                  প্রতিদিনের আপডেটেড লিস্ট ও দাম জানতে আমাদের চ্যানেলে জয়েন
                  করুন:{" "}
                  <Link
