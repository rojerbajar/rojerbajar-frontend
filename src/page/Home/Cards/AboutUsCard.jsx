    ...
    >
      ...
      >
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          <Box sx={{ mb: 4, textAlign: 'left', display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Stack spacing={3}>
            ...
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
              <ShoppingBasketTwoToneIcon sx={{ color: '#d35400', mt: 0.5, fontSize: 28 }} />
              <Typography 
                sx={{ 
                  color: '#444444', 
                  fontSize: { xs: '0.95rem', sm: '1.05rem' },
            ...
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
              <VerifiedTwoToneIcon sx={{ color: '#d35400', mt: 0.5, fontSize: 28 }} />
              <Typography 
                sx={{ 
                  color: '#444444', 
                  fontSize: { xs: '0.95rem', sm: '1.05rem' },
            ...
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
              <VolunteerActivismTwoToneIcon sx={{ color: '#e74c3c', mt: 0.5, fontSize: 28 }} />
              <Typography 
                sx={{ 
                  color: '#444444', 
                  fontSize: { xs: '0.95rem', sm: '1.05rem' },
              ...
              >
                আমরা শুধু একটা ব্যবসা দাঁড় করাতে আসিনি, আমরা এসেছি আপনাদের ঘরের একজন হয়ে প্রতিদিনের বাজারের দায়িত্বটা নিজেদের কাঁধে তুলে নিতে। <strong>আপনাদের আশীর্বাদ আর ভালোবাসাই আমাদের এগিয়ে যাওয়ার সবচেয়ে বড় শক্তি।</strong>
              </Typography>
            </Box>
          </Stack>
